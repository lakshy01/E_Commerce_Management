...
//	vector<item>new_item_temporary_brand;
//	new_item_temporary_brand.push_back(item1);
//	new_item_temporary_brand.push_back(item2);
//	new_item_temporary_brand.push_back(item3);
//	new_item_temporary_brand.push_back(item4);
//	new_item_temporary_brand.push_back(item5);
//	new_item_temporary_brand.push_back(item6);
	User_demand user;
...
//	vector<item>new_item_temporary_price;
//	new_item_temporary_price.push_back(item1);
//	new_item_temporary_price.push_back(item2);
//	new_item_temporary_price.push_back(item3);
//	new_item_temporary_price.push_back(item4);
//	new_item_temporary_price.push_back(item5);
//	new_item_temporary_price.push_back(item6);
	int option=1;
